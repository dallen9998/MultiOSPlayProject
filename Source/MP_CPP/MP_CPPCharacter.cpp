...
void AMP_CPPCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Quitting
		EnhancedInputComponent->BindAction(QuitAction, ETriggerEvent::Triggered, this, &AMP_CPPCharacter::Quit);
	}
	else
	{
...
void AMP_CPPCharacter::Quit(const FInputActionValue& Value)
{
